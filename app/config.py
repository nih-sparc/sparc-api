...
class Config(object):
    ...
    SPARC_GITHUB_REPO = os.environ.get("SPARC_GITHUB_REPO", "sparc-app-2")
    ...
    SPARC_TECH_LEADS_GITHUB_USERNAME = os.environ.get("SPARC_TECH_LEADS_GITHUB_USERNAME", "SparcTechLeads")
    SPARC_TECH_LEADS_SPARC_GITHUB_REPO = os.environ.get("SPARC_TECH_LEADS_SPARC_GITHUB_REPO", "SparcIssueAttachments")
    # Metrics
