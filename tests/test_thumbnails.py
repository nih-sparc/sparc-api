...
def test_segmentation_thumbnail(client):
    ...
    assert r.data.decode('utf-8').startswith('iVBORw0KGgoAAAANSUhEUgAAAEAAAABACAIAAAAlC+aJAAAFIElEQVR4nO1ZTYgcRRT+aiaaZTCXDegl')
...
def test_neurolucida_thumbnail(client):
    ...
    assert r.data.decode('utf-8').startswith('iVBORw0KGgoAAAANSUhEUgAAAtAAAAIcCAIAAABQHw4EAAAgAElEQVR4Xuy9T4hjWbLm+SXzBm7BG8IK')
